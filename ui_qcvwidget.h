...
public:
    ...
    void setupUi(QWidget *QCvWidget)
    {
        ...
        labelView->setStyleSheet(QString::fromUtf8("border: 1px solid;"));
        ...
        spinBoxBinaryThreshold->setObjectName(QString::fromUtf8("spinBoxBinaryThreshold"));
        ...
        checkBoxEnableBinaryThreshold->setObjectName(QString::fromUtf8("checkBoxEnableBinaryThreshold"));
